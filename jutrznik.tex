...
\vfill
\switchtobodyfont[16pt]\rubrum{\uppercase{wersja robocza}}\blank[10mm]
...
nic nie wiedział o~Józeﬁe. Działał on podstępnie przeciwko naszemu narodowi
...
\startday[title={Bóg Wybawiciel}] % 2 {{{1

\starthour[title={Wezwanie}] %{{{2
\ant Przyjdźcie, uwielbiajmy Pana,~* który jest Pasterzem swojego ludu
\startrubrica
Psalm Wezwania jak jak na \at{stronie}[invit-ps95].
\stoprubrica
...
z~niepokoju mówić nie potraﬁę.\pfin
...
\ant[n=3] Pan króluje,~* wesel się, ziemio.~\flexa

\startpsalmus[title={Psalm 97}]
Pan króluje, wesel się, ziemio,\pmed
\flexa~radujcie się, liczne wyspy!\pfin
...
\starthourpart[title={Pieśń Zachariasza}]
\ant[title={Ant. do pieśni Zachariasza}] Gdy Elżbieta usłyszała pozdrowienie
Maryi,~* wydała okrzyk i powiedziała:~/ A~skądże mi to, że Matka mojego Pana
przychodzi do mnie.
\startrubrica
...
\prosba Dozwól nam, Panie, naśladować Twoją Matkę, która obrała najlepszą cząstkę,
...
\starthourpart[title={Modlitwa}]
Okaż swą potęgę, Panie, i~przybądź,~\flexas niech Twoja opieka wyzwoli nas od
i~niebezpieczeństw grożących nam wskutek naszych grzechów,~\mediatios a~Twoja
moc niech nas zbawi. Który żyjesz i~królujesz z~Bogiem Ojcem w~jedności
Ducha Świętego,~\mediatios Bóg, przez wszystkie wieki wieków.



\startday[title={Bóg z~nami}] % 3 {{{1
...
Na harﬁe dziesięciostrunnej i~lirze,\pmed
...
\ant[n=2] Uznajcie wielkość~* naszego Boga.
...
Józeﬁe, synu Dawida, nie bój się wziąć do siebie Maryi, twej Małżonki; albowiem z Ducha Świętego jest to, co się w Niej poczęło. Porodzi Syna,
...
--- spraw, abyśmy jak gałązki trwali zawsze w~Tobie i~przynosili obﬁte owoce.
...
sposób odnowiłeś jego godność,~\flexas daj nam uczestniczyć w~bóstwie Twojego
Syna,~\mediatios który przyjął naszą ludzką naturę. Który z~Tobą żyje i~króluje
w~jedności Ducha Świętego,~\mediatios Bóg, przez wszystkie wieki wieków.


\startday[title={Bóg wzywa}] % 4 {{{1
...
Uwielbiajmy naszego Zbawiciela, który został oﬁarowany Bogu w~świątyni,
i~zanośmy do Niego nasze prośby:

\aklamacja Niech nasze oczy ujrzą Twe zbawienie.

\prosba Jezu Chryste, Ty zechciałeś, aby zgodnie z~Prawem oﬁarowano Cię w~świątyni,
--- naucz nas samych siebie składać w~oﬁerze Kościoła razem z~Tobą.
...
\starthourpart[title={Modlitwa}]
Boże, Ty kierujesz swoim ludem przez pasterzy,~\flexas ześlij na swój Kościół
ducha pobożności i~męstwa~\mediatios i~powołaj ludzi, którzy będą godnie
pełnili służbę przy ołtarzu oraz mężnie i~pokornie głosili Ewangelię. Przez
naszego Pana Jezusa Chrystusa, Twojego Syna,~\flexas który z~Tobą żyje
i~króluje w~jedności Ducha Świętego,~\mediatios Bóg, przez wszystkie wieki
wieków.


\startday[title={Bóg posyła}] % 5 {{{1
\starthour[title={Wezwanie}] %{{{2
% XXX tu gdzieś kreska?
...
Niech się dziś stanie nasza oﬁara dla Ciebie\pmed
...
grać Ci będę na harﬁe o~dziesięciu strunach.\pfin
...
prawdy,~\flexas wejrzyj na swoje wielkie żniwo i~poślij na nie robotników, aby
głosili Ewangelię wszelkiemu stworzeniu,~\mediatios niech Twój lud zgromadzony
przez Słowo Życia i~pokrzepiony mocą sakramentów kroczy drogą zbawienia
i~miłości. Przez naszego Pana Jezusa Chrystusa, Twojego Syna który z~Tobą żyje
i~króluje w~jedności Ducha Świętego,~\mediatios Bóg, przez wszystkie wieki
wieków.


\startday[title={Bóg walczy}] % 6 {{{1
\starthour[title={Wezwanie}] %{{{2
% XXX kreska?
...
Mówił nieprzyjaciel: \startquote Będę ścigał, dopadnę,\pflx
rozdzielę łupy i~nasycę mą duszę,\pmed
dobędę miecza, moja ręka ich zniszczy!\stopquote\pfin
...
q~wysławiajcie Go, wszystkie ludy!\pfin
...
ciemności~\mediatios i~wyciągnij w~naszej obronie swoją potężną prawicę. Przez
naszego Pana Jezusa Chrystusa, Twojego Syna,~\flexas który z~Tobą żyje
i~króluje w~jedności Ducha Świętego,~\mediatios Bóg, przez wszystkie wieki
wieków.


\startday[title={Plagi}] % 7 {{{1
...
i~mówisz: \startquote Wracajcie, synowie ludzcy\stopquote.\pfin
...
\startquote Długo milczałem,\pmed
...
a~miejsca wyboiste w~równinę\stopquote.\pfin
\stoppsalmus
...
\starthourpart[title={Modlitwa}]
Wszechmogący Boże, wejrzyj na zgromadzenie Twoich wiernych~\flexas i~spraw, aby
nasze dusze oczyszczone przez umartwienie ciała~\mediatios jaśniały pragnieniem
posiadania Ciebie. Przez naszego Pana Jezusa Chrystusa Twojego Syna,~\flexas
który z~Tobą żyje i~króluje w~jedności Ducha Świętego,~\mediatios Bóg, przez
wszystkie wieki wieków.


\startday[title={Obłok}] % 8 {{{1
...
\startpsalmus[title={Psalm 97}]
Pan króluje, wesel się, ziemio,\pmed
q~radujcie się, liczne wyspy!\pfin
Obłok i~ciemność wokół Niego,\pmed
prawo i~sprawiedliwość podstawą Jego tronu.\pfin
Przed Jego obliczem idzie ogień\pmed
i~dokoła pożera nieprzyjaciół Jego.\pfin
...
i~wzmocnij mnie duchem oﬁarnym\pfin
...
Oﬁarą bowiem Ty się nie radujesz\pmed
a~całopalenia, choćbym dał, nie przyjmiesz.\pfin
Boże, moją oﬁarą jest duch skruszony,\pmed
...
Wtedy przyjmiesz prawe oﬁary: dary i~całopalenia,\pmed
...
Choć drzewo ﬁgowe nie rozwija pąków\pmed
...
q~wysławiaj twego Boga, Syjonie!\pfin
...
\startquote Ten, który rozproszył Izraela, znów go zgromadzi\pmed
i~będzie nad nim czuwał jak pasterz nad swym stadem\stopquote.\pfin
...
Tłuszczem z~oﬁar obﬁcie obdarzę kapłanów,\pmed
...
\startday[title={Zwycięstwo}] % 11 {{{1
\starthour[title={Jutrznia}] %{{{2
...
q~wykrzykujcie na cześć Boga Jakuba!\pfin
...
\startquote Uwolniłem od brzemienia jego barki,\pmed
...
i~sycił miodem z~opoki\stopquote.\pfin
\stoppsalmus
...
Panie Jezu Chryste, Królu chwały, Ty raz oﬁarowałeś się za ludzkie grzechy
...
\startday[title={Przymierze}] % 13 {{{1
\startday[title={Ziemia obiecana}] % 14 {{{1
...
\startquote Chodźcie, wejdźmy na górę Pana,\pmed
...
i~z~Jeruzalem słowo Pana\stopquote.\pfin
...
\startday[title={Droga przez pustynię}] % 15 {{{1
...
i~jak wodną głębiną obﬁcie ich napoił.\pfin
...
Ojcze nasz.
\starthourpart[title={Modlitwa}]
Boże, Ty miłujesz ludzi, pokornie Cię błagamy, ześlij na nas obﬁtą łaskę
...
Powalił ich winnice i~ﬁgi\pmed
